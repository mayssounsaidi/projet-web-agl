...
<section class="contact" id="contact">
   ...
   <div class="row">
      <form action="signup.php" method="post"> <!-- Assurez-vous de spécifier l'URL correcte du script PHP -->
           <input type="text" name="nom" placeholder="name" class="box">
           <input type="text" name="prenom" placeholder="prenom" class="box">
           <input type="number" name="telephone" placeholder="number" class="box">
           <input type="email" name="email" placeholder="email" class="box">
           <input name="password" class="box" name="mp" placeholder="password" class="box">
           <input type="submit" value="Resgister" class="btn">
       </form>
       <div class="image">
           <img src="assets/imgimage1.jpg" alt="">
       </div>
   </div>
</section>
